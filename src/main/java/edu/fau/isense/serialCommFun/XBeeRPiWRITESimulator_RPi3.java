...
public class XBeeRPiWRITESimulator_RPi3 {
	...
	public static void main(String[] args) {
        ...
        while (portList.hasMoreElements()) {
            ...
            if (portId.getPortType() == CommPortIdentifier.PORT_SERIAL) {
            	...
            	if (portId.getName().equals(portName)) { // USB with Sparkfun FTDI Breakout
            		System.out.println("port is " + portName +  "...");
                    try {
                        serialPort = (SerialPort) portId.open("XBeeRPiWRITESimulator_RPi3", 2000);
                    ...
                    while(true) {
                    	...
                    	System.out.println("Made it to the while loop ...");
                    		...
                    		message[1] = 1;		//orgID
                			message[2] = 3;		//networkID  2=RPi2; 3=RPi3
